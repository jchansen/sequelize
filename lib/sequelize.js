...
Sequelize.prototype.define = function(modelName, attributes, options) { // testhint options:none
  ...
  // if you call "define" multiple times for the same modelName and schema, do not clutter the factory
  if (this.isDefined(modelName)) {
    var previousModel = this.modelManager.getModel(modelName);
    if (previousModel.options.schema === options.schema) {
      this.modelManager.removeModel(previousModel);
    }
  }
